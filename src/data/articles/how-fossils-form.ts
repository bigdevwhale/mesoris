...
export const HowFossilsForm: Article = {
    id: 'how-fossils-form',
    ...
    titleJa: '化石はどのようにできるのか？',
    titleZh: '化石是如何形成的？',
    titleKo: '화석은 어떻게 형성될까?',
    titleKk: 'Қазбалар қалай пайда болады?',
    titleHi: 'जीवाश्म कैसे बनते हैं?',
    ...
    summaryJa: '生きた恐竜から博物館の化石になるまでの驚くべき旅路 — 数百万年を要するプロセスです。',
    summaryZh: '从活生生的恐龙到博物馆中的化石的不可思议之旅——一个需要数百万年的过程。',
    summaryKo: '살아있는 공룡에서 박물관의 화석까지의 놀라운 여정 — 수백만 년이 걸리는 과정입니다.',
    summaryKk: 'Тірі динозаврдан мұражайдағы қазбаға дейінгі таңғажайып сапар — миллиондаған жылдарды қажет ететін процесс.',
    summaryHi: 'एक जीवित डायनासोर से संग्रहालय में रखे जीवाश्म तक की अविश्वसनीय यात्रा — एक प्रक्रिया जिसमें लाखों वर्ष लगते हैं।',
...
- **Calchi e impronte** : L'osso si dissolve lasciando una cavita nella roccia`,
    contentJa: `## 化石はどのようにできるのか

化石になることは、信じられないほど稀なプロセスです。これまで存在した生物の圧倒的多数は化石にならず、食べられたり、腐敗したり、風化して消えていきました。恐竜が化石になるためには、非常に特殊な一連の出来事が起きる必要がありました。

### 化石化のプロセス

**1. 素早い埋没**
死後、恐竜の体は砂や泥、シルトなどの堆積物によって素早く埋められる必要がありました。これにより死体は腐肉食者から守られ、分解が遅くなりました。洪水、地滑り、砂嵐が主な埋没のメカニズムでした。

**2. 鉱物による置換**
何千年もの間、溶存鉱物を豊富に含む地下水が埋もれた骨に染み込みました。シリカや方解石などの鉱物が、分子レベルでゆっくりと元の有機物を置き換え、骨を石へと変えていきました。

**3. 圧力と時間**
堆積物が何層にも積み重なりました。巨大な圧力と化学変化の組み合わせが、この変化を完成させました。かつて生きた骨だったものは、今や固い岩石です。

**4. 発見**
数百万年後、侵食や発掘によって化石は再び地表に現れ、発見されるのを待ちます。

### 化石の種類

- **体化石**: 生物そのものの一部（骨、歯、貝殻）
- **生痕化石**: 活動の証拠（足跡、巣、糞）
- **型と鋳型**: 岩石に残された印象`,
    contentZh: `## 化石是如何形成的？

化石化是一个极其罕见的过程。绝大多数曾经存在过的生物从未变成化石——它们被吃掉、腐烂或被风化侵蚀掉了。要让恐龙变成化石，必须发生一系列非常特殊的事件。

### 化石化过程

**1. 快速掩埋**
恐龙死后，其尸体需要被沉积物（沙子、泥浆或淤泥）快速掩埋。这保护了遗骸免受食腐动物的侵扰，并减缓了分解过程。洪水、山体滑坡和沙尘暴是常见的掩埋方式。

**2. 矿物置换**
经过数千年，富含溶解矿物的地下水渗入被掩埋的骨骼。二氧化硅和方解石等矿物以分子为单位缓慢地取代了原始的有机物质，将骨骼变成了石头。

**3. 压力与时间**
一层又一层的沉积物堆积在上面。巨大的压力加上化学变化完成了这一转变。曾经是活生生的骨头，如今变成了坚硬的岩石。

**4. 发现**
几百万年后，侵蚀或挖掘使化石重新暴露在地表，等待被发现。

### 化石的类型

- **实体化石**：生物体的实际部分（骨骼、牙齿、贝壳）
- **遗迹化石**：活动证据（脚印、巢穴、粪便）
- **模铸化石**：岩石中留下的印痕`,
    contentKo: `## 화석은 어떻게 형성될까

화석화는 매우 희귀한 과정입니다. 지금까지 존재했던 생물의 압도적 대다수는 화석이 되지 못했습니다 — 먹히거나, 부패하거나, 풍화되어 사라졌습니다. 공룡이 화석이 되기 위해서는 아주 특별한 일련의 사건이 일어나야 했습니다.

### 화석화 과정

**1. 빠른 매몰**
죽은 후 공룡의 몸은 퇴적물 — 모래, 진흙, 또는 실트 — 에 의해 빠르게 묻혀야 했습니다. 이것은 시체를 청소 동물로부터 보호하고 분해를 늦추었습니다. 홍수, 산사태, 모래폭풍이 일반적인 매몰 메커니즘이었습니다.

**2. 광물 치환**
수천 년에 걸쳐 용해된 광물이 풍부한 지하수가 묻힌 뼈 사이로 스며들었습니다. 실리카와 방해석 같은 광물이 분자 수준에서 천천히 원래 유기물을 대체하여 뼈를 돌로 변하게 했습니다.

**3. 압력과 시간**
퇴적물이 층층이 위로 쌓였습니다. 엄청난 압력과 화학적 변화가 결합되어 변환을 완료했습니다. 한때 살아있는 뼈였던 것은 이제 단단한 암석이 되었습니다.

**4. 발견**
수백만 년 후, 침식이나 발굴이 화석을 다시 지표면으로 가져왔고, 발견되기를 기다렸습니다.

### 화석의 종류

- **신체 화석**: 유기체의 실제 부분 (뼈, 이빨, 껍질)
- **흔적 화석**: 활동의 증거 (발자국, 둥지, 배설물)
- **몰드와 캐스트**: 암석에 남겨진 자국`,
    contentKk: `## Қазбалар қалай пайда болады

Қазбалану — өте сирек процесс. Бұрын өмір сүрген тірі ағзалардың басым көпшілігі ешқашан қазбаланбады — олар желінді, шіріді немесе мүжіліп кетті. Динозаврдың қазба болуы үшін өте нақты оқиғалар тізбегі орын алуы керек еді.

### Қазбалану процесі

**1. Жылдам көмілу**
Өлгеннен кейін динозаврдың денесі шөгінділермен — құм, балшық немесе тұнбамен — тез көмілуі керек болды. Бұл қалдықтарды өлексемен қоректенушілерден қорғап, шіруді баяулатты. Су тасқындары, жер көшкіндері және құмды дауылдар кең таралған көмілу механизмдері болды.

**2. Минералды алмастыру**
Мыңдаған жылдар бойы еріген минералдарға бай жер асты сулары көмілген сүйектерге сіңді. Кремнезем және кальцит сияқты минералдар бастапқы органикалық материалды молекула сайын баяу алмастырып, сүйекті тасқа айналдырды.

**3. Қысым және уақыт**
Шөгінді қабаттары үстіне қабаттала жиналды. Орасан зор қысым химиялық өзгерістермен бірге түрленуді аяқтады. Бір кездері тірі сүйек болған нәрсе енді қатты тас болды.

**4. Ашылу**
Миллиондаған жылдардан кейін эрозия немесе қазба жұмыстары қазбаны жер бетіне қайта шығарды, ашылуын күтіп.

### Қазбалардың түрлері

- **Дене қазбалары**: ағзаның нақты бөліктері (сүйектер, тістер, қабыршақтар)
- **Із қазбалары**: белсенділік дәлелдері (аяқ іздері, ұялар, нәжістер)
- **Қалыптар мен бедерлер**: тау жынысында қалған таңбалар`,
    contentHi: `## जीवाश्म कैसे बनते हैं?

जीवाश्मीकरण (fossilization) एक अविश्वसनीय रूप से दुर्लभ प्रक्रिया है। जितने भी जीव कभी पृथ्वी पर रहे, उनमें से अधिकांश कभी जीवाश्म नहीं बने — वे खा लिए गए, सड़ गए, या अपक्षयित हो गए। किसी डायनासोर के जीवाश्म बनने के लिए घटनाओं की एक बहुत विशेष श्रृंखला होनी चाहिए थी।

### जीवाश्मीकरण की प्रक्रिया

**1. तेज़ दफ़न**
मृत्यु के बाद, डायनासोर के शरीर को तलछट (sediment) — रेत, कीचड़ या गाद — से जल्दी ढक दिया जाना ज़रूरी था। इसने अवशेषों को मांसाहारियों से बचाया और विघटन को धीमा किया। बाढ़, भूस्खलन और रेत के तूफ़ान सामान्य दफ़न तंत्र थे।

**2. खनिज प्रतिस्थापन**
हज़ारों वर्षों तक, घुले हुए खनिजों से भरपूर भूजल दफ़न हड्डियों में रिसता रहा। सिलिका और कैल्साइट जैसे खनिजों ने मूल कार्बनिक पदार्थ को अणु-दर-अणु धीरे-धीरे बदला, हड्डी को पत्थर में बदल दिया।

**3. दबाव और समय**
ऊपर तलछट की परतों पर परतें जमती गईं। अपार दबाव ने रासायनिक परिवर्तनों के साथ मिलकर यह रूपांतरण पूरा किया। जो कभी जीवित हड्डी थी, वह अब ठोस चट्टान बन चुकी थी।

**4. खोज**
लाखों वर्षों बाद, कटाव या खुदाई ने जीवाश्म को फिर से सतह पर ला दिया, खोजे जाने की प्रतीक्षा में।

### जीवाश्मों के प्रकार

- **शारीरिक जीवाश्म**: जीव के वास्तविक भाग (हड्डियाँ, दाँत, खोल)
- **चिह्न जीवाश्म**: गतिविधि के साक्ष्य (पदचिह्न, घोंसले, विष्टा)
- **साँचे और ढले हुए जीवाश्म**: चट्टान में छोड़े गए छाप`,
...
Ecco perche i fossili sono cosi rari — tutto deve essere perfetto!`,
    kidsVersionJa: `## 化石はどうやってできるの？

想像してみて！地面の下に6600万年も眠っていたT-レックスの歯を見つけたんだ。どうやってそこに来たのかな？

### 魔法のレシピ

1. **すばやく隠す！** 恐竜が死んだら、泥や砂がすぐに覆わなきゃいけない。
2. **水を加える！** 特別なミネラルを含んだ水が骨に染み込む。
3. **何百万年も待つ！** ミネラルがゆっくりと骨を石に変えていく。
4. **掘り出す！** 上にある岩が風と雨で削られて…そして…

ラッキーな科学者が、何百万年も誰も見たことのなかった化石を発見するんだ！`,
    kidsVersionZh: `## 化石是如何形成的？

想象一下！你发现了一颗埋在地下6600万年的霸王龙牙齿。它是怎么来到那里的呢？

### 神奇配方

1. **快快藏起来！** 恐龙死后，泥巴或沙子必须迅速盖住它。
2. **加点水！** 含有特殊矿物质的水渗入骨骼。
3. **等上几百万年！** 矿物质慢慢地把骨头变成了石头。
4. **挖出来！** 风雨侵蚀掉上面的岩石，然后……

幸运的科学家发现了这块几百万年无人见过的化石！`,
    kidsVersionKo: `## 화석은 어떻게 생길까?

상상해보세요! 땅속에 6600만년 동안 묻혀 있던 티라노사우루스 이빨을 발견했어요. 어떻게 거기에 오게 된 걸까요?

### 마법의 레시피

1. **빨리 숨겨라!** 공룡이 죽으면 진흙이나 모래가 빨리 덮어야 해요.
2. **물을 더해라!** 특별한 미네랄이 든 물이 뼈에 스며들어요.
3. **수백만 년을 기다려라!** 미네랄이 천천히 뼈를 돌로 바꿔요.
4. **파내라!** 바람과 비가 위의 바위를 깎아내고, 그러면...

운 좋은 과학자가 수백만 년 동안 아무도 보지 못한 화석을 발견하는 거예요!`,
    kidsVersionKk: `## Қазбалар қалай пайда болады?

Елестет! Жер астында 66 МИЛЛИОН жыл болған T-Rex тісін тауып алдың. Ол жерге қалай келді?

### Сиқырлы рецепт

1. **Тез жасыр!** Динозавр өлгенде, балшық немесе құм тез жабуы керек.
2. **Су қос!** Арнайы минералдары бар су сүйектерге сіңеді.
3. **Миллиондаған жыл күт!** Минералдар баяу сүйектерді тасқа айналдырады.
4. **Қазып шығар!** Жел мен жаңбыр үстіндегі тасты мүжіді, содан кейін...

Бақытты ғалым миллиондаған жыл бойы ешкім көрмеген қазбаны табады!`,
    kidsVersionHi: `## जीवाश्म कैसे बनते हैं?

कल्पना करो कि तुम्हें ज़मीन के अंदर 66 मिलियन साल से दबे टी-रेक्स (T-Rex) के एक दाँत मिल जाए। वह वहाँ पहुँचा कैसे?

### जादुई नुस्खा

1. **जल्दी छुपाओ!** जब डायनासोर मरा, तो कीचड़ या रेत ने उसे जल्दी ढक दिया।
2. **पानी मिलाओ!** विशेष खनिजों वाला पानी हड्डियों में रिस गया।
3. **लाखों साल इंतज़ार करो!** खनिजों ने धीरे-धीरे हड्डियों को पत्थर बना दिया।
4. **खोदकर बाहर निकालो!** हवा और बारिश ने ऊपर की चट्टान को घिसा, और फिर...

एक खुशकिस्मत वैज्ञानिक को वह जीवाश्म मिला जिसे लाखों साल से किसी ने नहीं देखा था!`,
  }

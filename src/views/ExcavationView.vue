        ...
        <div class="p-5">
          ...
          <div class="grid grid-cols-2 gap-3 mb-4">
            ...
            <div class="flex flex-col gap-1">
              ...
              <span class="text-sm font-semibold text-[var(--color-text-primary)]">{{ translatedDino.dimensions.weightKg.toLocaleString(locale === 'kk' ? 'kk-KZ' : locale === 'hi' ? 'hi-IN' : locale === 'ko' ? 'ko-KR' : locale === 'zh' ? 'zh-CN' : locale === 'ja' ? 'ja-JP' : locale === 'it' ? 'it-IT' : locale === 'fr' ? 'fr-FR' : locale === 'de' ? 'de-DE' : locale === 'es' ? 'es-ES' : locale === 'ru' ? 'ru-RU' : 'en-US') }} {{ t('ui.compare.kgUnit') }}</span>
            </div>
          </div>

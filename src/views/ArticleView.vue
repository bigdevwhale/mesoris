...
const seoTitle = computed(() => {
  ...
  const title = pickLocale(article.value.title, article.value.titleRu, article.value.titleEs, article.value.titleDe, article.value.titleFr, article.value.titleIt, article.value.titleJa, article.value.titleZh, article.value.titleKo, article.value.titleKk, article.value.titleHi)
  return pickLocale(
...
const renderedContent = computed(() => {
  ...
  const raw = modeStore.isKidsMode
    ? pickLocale(article.value.kidsVersion, article.value.kidsVersionRu, article.value.kidsVersionEs, article.value.kidsVersionDe, article.value.kidsVersionFr, article.value.kidsVersionIt, article.value.kidsVersionJa, article.value.kidsVersionZh, article.value.kidsVersionKo, article.value.kidsVersionKk, article.value.kidsVersionHi)
    : pickLocale(article.value.content, article.value.contentRu, article.value.contentEs, article.value.contentDe, article.value.contentFr, article.value.contentIt, article.value.contentJa, article.value.contentZh, article.value.contentKo, article.value.contentKk, article.value.contentHi)
...
const ttsText = computed(() => {
  if (!article.value) return ''
  const title = pickLocale(article.value.title, article.value.titleRu, article.value.titleEs, article.value.titleDe, article.value.titleFr, article.value.titleIt, article.value.titleJa, article.value.titleZh, article.value.titleKo, article.value.titleKk, article.value.titleHi)
  const summary = pickLocale(article.value.summary, article.value.summaryRu, article.value.summaryEs, article.value.summaryDe, article.value.summaryFr, article.value.summaryIt, article.value.summaryJa, article.value.summaryZh, article.value.summaryKo, article.value.summaryKk, article.value.summaryHi)
  const raw = modeStore.isKidsMode
    ? pickLocale(article.value.kidsVersion, article.value.kidsVersionRu, article.value.kidsVersionEs, article.value.kidsVersionDe, article.value.kidsVersionFr, article.value.kidsVersionIt, article.value.kidsVersionJa, article.value.kidsVersionZh, article.value.kidsVersionKo, article.value.kidsVersionKk, article.value.kidsVersionHi)
    : pickLocale(article.value.content, article.value.contentRu, article.value.contentEs, article.value.contentDe, article.value.contentFr, article.value.contentIt, article.value.contentJa, article.value.contentZh, article.value.contentKo, article.value.contentKk, article.value.contentHi)
...
<template>
  <div v-if="article" class="max-w-3xl mx-auto px-4 py-10">
    ...
    <div class="flex items-center gap-3 pb-4">
      <h1 class="text-display-md flex-1">{{ pickLocale(article.title, article.titleRu, article.titleEs, article.titleDe, article.titleFr, article.titleIt, article.titleJa, article.titleZh, article.titleKo, article.titleKk, article.titleHi) }}</h1>
      <button
        v-if="ttsSupported"
        type="button"
    ...
    <p class="text-body-lg mb-8">{{ pickLocale(article.summary, article.summaryRu, article.summaryEs, article.summaryDe, article.summaryFr, article.summaryIt, article.summaryJa, article.summaryZh, article.summaryKo, article.summaryKk, article.summaryHi) }}</p>

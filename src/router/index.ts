...
const PAGE_TITLES: Record<string, Record<string, string>> = {
  ...
  es: {
    ...
    'dino-match3': 'Dino Match-3',
    'predator-prey': 'Depredador y presa',
  ...
  fr: {
    ...
    'dino-match3': 'Dino Match-3',
    'predator-prey': 'Prédateur et proie',
  ...
  it: {
    ...
    'dino-match3': 'Dino Match-3',
    'predator-prey': 'Predatore e preda',
